 ...
 * @modify date 2022-07-11 16:13:49
...
static void atomicAccess(void)
{
    ...
    uint8_t *pWriter = archcap_c_perms_set(&array[0], 0b010000000001000001);
    uint8_t *pReader = archcap_c_perms_set(&array[0], 0b100000000001000001);
